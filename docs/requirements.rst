...
===============================================
Requirements for scikit-surgerytorch
===============================================

This is the software requirements file for scikit-surgerytorch, part of the
SNAPPY project. The requirements listed below should define
what scikit-surgerytorch does. Each requirement can be matched to a unit test that
